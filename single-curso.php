...
<?php switch ($tipodeinformacao) {
 ...
 <?php break;
	...
	<li class="card-page-curso__list card-page-curso__list-local"> <strong class="card-page-curso__list--label">Local:</strong>  <?php the_field('acf_curso_endereco_descritivo'); ?>
					...
					<?php
						$location = get_field('acf_curso_endereco_mapa');
	...
	<aside id="sidebar" class="small-12 medium-4 columns">
 		...
 		<!-- <a href="#" class="button button-curso-inscrever-se expand">Inscrever-se</a> -->
		<h5>Formulário de pré-inscrição</h5>

		<div class="formulario-pre-inscicao">
			<?php echo do_shortcode( '[contact-form-7 id="243"  title="Formulário de Pré-Inscrição"]' ); ?>
		</div> <!-- // formulario-pre-inscicao -->
