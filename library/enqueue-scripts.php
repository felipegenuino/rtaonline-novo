...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	...
	wp_enqueue_style( 'style-name', get_stylesheet_uri() );
	 wp_enqueue_style( 'foundation-style', get_stylesheet_directory_uri() . '/assets/css/foundation.min.css' );
	...
	wp_register_script( 'foundation', get_template_directory_uri() . '/assets/js/foundation.js', array('jquery'), '5.5.2', true );
